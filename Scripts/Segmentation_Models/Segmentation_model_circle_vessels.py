...
def predict_roi(roi_bgr: np.ndarray, model_path="circles_unet.pth") -> np.ndarray:
...
if __name__ == "__main__":
    IMG_DIR  = r"C:\Users\jandr\OneDrive - Universidad del rosario\Gui_xylem\ROIs_circles"
    MASK_DIR = r"C:\Users\jandr\OneDrive - Universidad del rosario\Gui_xylem\Masks_circles"
